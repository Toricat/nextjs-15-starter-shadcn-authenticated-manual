...
import SetupDetails from '@/components/home/setup-details';
...
const HomePage: React.FC = () => {
    return (
        <>
            ...
            <main className='mx-auto mt-6 flex h-full max-w-7xl flex-col justify-center gap-6 px-3 font-[family-name:var(--font-geist-sans)] sm:mt-3 sm:gap-12 sm:px-0'>
                <div className='row-start-4 flex flex-col items-center'>
